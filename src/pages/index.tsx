    ...
    <>
      <div className="flex flex-col items-center h-screen pt-16 my-auto mt-0 bg-black bg-opacity-50 bg-center bg-cover lg:justify-center place-content-center wedding bg-blend-darken">
        <div className="max-w-lg place-content-center">
          <h1 className="mb-5 text-6xl text-center text-orange-200 lg:text-9xl lg:font-extrabold lg:-mx-20 pt-52">
            Wanita & Pria
          </h1>
          <p className="pt-16 text-xl text-center text-orange-200 lg:text-2xl">Kepada</p>
          <p className="py-2 text-3xl text-center text-orange-200 lg:text-5xl">Nama Tamu</p>
